...
#include "D:/Amy_Engine/resource/include/components/camera/Camera.h"
    ...
    namespace NameSpace_Core::NameSpace_Meta::NameSpace_Serializer{
        ...
        template<> inline const JSON Serializer::Write<Camera_Base>(const Camera_Base& Instance){
    ...
    namespace NameSpace_Core::NameSpace_Meta::NameSpace_Serializer{
        ...
        template<> inline const JSON Serializer::Write<Camera_First_Persion>(const Camera_First_Persion& Instance){
            JSON Json_Context { JSON::object() };
    ...
    namespace NameSpace_Core::NameSpace_Meta::NameSpace_Serializer{
        ...
        template<> inline const JSON Serializer::Write<Camera_Third_Persion>(const Camera_Third_Persion& Instance){
            JSON Json_Context { JSON::object() };
    ...
    namespace NameSpace_Core::NameSpace_Meta::NameSpace_Serializer{
        ...
        template<> inline const JSON Serializer::Write<Camera_Free>(const Camera_Free& Instance){
            JSON Json_Context { JSON::object() };
    ...
    namespace NameSpace_Core::NameSpace_Meta::NameSpace_Serializer{
        ...
        template<> inline const JSON Serializer::Write<Camera_Resource>(const Camera_Resource& Instance){
            JSON Json_Context { JSON::object() };
