...
#include "D:/Amy_Engine/function/include/frame/components/camera/Camera_Component.h"
    ...
    namespace NameSpace_Core::NameSpace_Meta::NameSpace_Serializer{
        ...
        template<> inline const JSON NameSpace_Core::NameSpace_Meta::NameSpace_Serializer::Serializer::Write<Camera_Component>(const Camera_Component& Instance){
        ...
        template<> inline Camera_Component& NameSpace_Core::NameSpace_Meta::NameSpace_Serializer::Serializer::Read<Camera_Component>(const JSON& Json_Context, Camera_Component &Instance){
