...
namespace NameSpace_Function::Namespace_Global {
	...
	Global_Systemer::Global_Systemer(void) :
		...
		Main_Window{ std::make_shared<Window_System>() },
		Main_Input{ std::make_shared<Input_System>(this->Main_Window) },
		Main_Render_System{ std::make_shared<Render_System>(Render_System_Initialization_Info {this->Main_Window}) }
		/*,
