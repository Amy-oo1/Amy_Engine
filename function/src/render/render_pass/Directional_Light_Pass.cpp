...
namespace NameSpace_Function::NameSpace_Render::NameSpace_Pass {
	...
	using namespace NameSpace_RHI;//TODO Move 
	...
	void Directional_Light_Pass::Draw(void) {
		...
		//NOTE :Directional Light Shadow Begin Pass
		{
		...
		//NOTE :Mesh
		{
			...
			*reinterpret_cast<Mesh_Directional_Light_Shadow_Per_Frame_Storage_Buffer_Object*>(reinterpret_cast<uintptr_t>(Ref_Global_Storage_Buffer.Global_Upload_Ring_Buffer_Mapped_Mamary) + Per_Frame_Dynamic_Offset) = this->m_Mesh_Directional_Light_Shadow_Per_Frame_Storage_Buffer_Object;
