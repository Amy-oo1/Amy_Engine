...
namespace NameSpace_Function::NameSpace_Render::NameSpace_Pass {
	...
	void Point_Light_Pass::Setup_Render_Pass(void) {
		RHI_Attachment_Description Point_Light_Shadow_Color_Attachment_Description{};
		{
			Point_Light_Shadow_Color_Attachment_Description.Flags = 0;
			Point_Light_Shadow_Color_Attachment_Description.Format = this->m_Frame_Buffer.Attachments[0].Format;
			Point_Light_Shadow_Color_Attachment_Description.Samples = RHI_SAMPLE_COUNT_FLAG_BIT::RHI_SAMPLE_COUNT_1_BIT;
			Point_Light_Shadow_Color_Attachment_Description.Load_Op = RHI_ATTACHMENT_LOAD_OP::RHI_ATTACHMENT_LOAD_OP_CLEAR;
			Point_Light_Shadow_Color_Attachment_Description.Store_Op = RHI_ATTACHMENT_STORE_OP::RHI_ATTACHMENT_STORE_OP_STORE;
			Point_Light_Shadow_Color_Attachment_Description.Stencil_Load_Op = RHI_ATTACHMENT_LOAD_OP::RHI_ATTACHMENT_LOAD_OP_DONT_CARE;
			Point_Light_Shadow_Color_Attachment_Description.Stencil_Store_Op = RHI_ATTACHMENT_STORE_OP::RHI_ATTACHMENT_STORE_OP_DONT_CARE;
			Point_Light_Shadow_Color_Attachment_Description.Initial_Layout = RHI_IMAGE_LAYOUT::RHI_IMAGE_LAYOUT_UNDEFINED;
			Point_Light_Shadow_Color_Attachment_Description.Final_Layout = RHI_IMAGE_LAYOUT::RHI_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL;
		}
		...
		RHI_Attachment_Reference Shadow_Pass_Depth_Attachment_Reference{};
		{
			Shadow_Pass_Depth_Attachment_Reference.Attachment = 1;
			Shadow_Pass_Depth_Attachment_Reference.Layout = RHI_IMAGE_LAYOUT::RHI_IMAGE_LAYOUT_DEPTH_STENCIL_ATTACHMENT_OPTIMAL;
		}
		...
		RHI_Subpass_Description Sub_Pass{};
		{
			...
			Sub_Pass.Depth_Stencil_Attachment = &Shadow_Pass_Depth_Attachment_Reference;
		...
		{
			Sub_Pass_Dependency.Src_Subpass = 0;
			Sub_Pass_Dependency.Dst_Subpass = RHI_SUBPASS_EXTERNAL;;
	...
	void Point_Light_Pass::Setup_Descriptor_Set_Layout(void) {
		...
		RHI_Descriptor_Set_Layout_Binding Mesh_Point_Light_Shadow_Global_Layout_Per_Frame_Storage_Buffer_Binding{};
		{
			Mesh_Point_Light_Shadow_Global_Layout_Per_Frame_Storage_Buffer_Binding.Binding = 0;
			Mesh_Point_Light_Shadow_Global_Layout_Per_Frame_Storage_Buffer_Binding.Descriptor_Type = RHI_DESCRIPTOR_TYPE::RHI_DESCRIPTOR_TYPE_STORAGE_BUFFER_DYNAMIC;
			Mesh_Point_Light_Shadow_Global_Layout_Per_Frame_Storage_Buffer_Binding.Descriptor_Count = 1;
			Mesh_Point_Light_Shadow_Global_Layout_Per_Frame_Storage_Buffer_Binding.Stage_Flags = RHI_SHADER_STAGE_FLAG_BITS::RHI_SHADER_STAGE_GEOMETRY_BIT | RHI_SHADER_STAGE_FLAG_BITS::RHI_SHADER_STAGE_FRAGMENT_BIT;
			Mesh_Point_Light_Shadow_Global_Layout_Per_Frame_Storage_Buffer_Binding.Immutable_Samplers = nullptr;
		}

		RHI_Descriptor_Set_Layout_Binding Mesh_Point_Light_Shadow_Global_Layout_Per_Draw_Call_Storage_Buffer_Binding{};
		{
			Mesh_Point_Light_Shadow_Global_Layout_Per_Draw_Call_Storage_Buffer_Binding.Binding = 1;
			Mesh_Point_Light_Shadow_Global_Layout_Per_Draw_Call_Storage_Buffer_Binding.Descriptor_Type = RHI_DESCRIPTOR_TYPE::RHI_DESCRIPTOR_TYPE_STORAGE_BUFFER_DYNAMIC;
			Mesh_Point_Light_Shadow_Global_Layout_Per_Draw_Call_Storage_Buffer_Binding.Descriptor_Count = 1;
			Mesh_Point_Light_Shadow_Global_Layout_Per_Draw_Call_Storage_Buffer_Binding.Stage_Flags = to_underlying(RHI_SHADER_STAGE_FLAG_BITS::RHI_SHADER_STAGE_VERTEX_BIT);
			Mesh_Point_Light_Shadow_Global_Layout_Per_Draw_Call_Storage_Buffer_Binding.Immutable_Samplers = nullptr;
		}

		RHI_Descriptor_Set_Layout_Binding Mesh_Point_Light_Shadow_Global_Layout_Per_Draw_Call_Vertex_Blending_Storage_Buffer_Binding{};
		{
			Mesh_Point_Light_Shadow_Global_Layout_Per_Draw_Call_Vertex_Blending_Storage_Buffer_Binding.Binding = 2;
			Mesh_Point_Light_Shadow_Global_Layout_Per_Draw_Call_Vertex_Blending_Storage_Buffer_Binding.Descriptor_Type = RHI_DESCRIPTOR_TYPE::RHI_DESCRIPTOR_TYPE_STORAGE_BUFFER_DYNAMIC;
			Mesh_Point_Light_Shadow_Global_Layout_Per_Draw_Call_Vertex_Blending_Storage_Buffer_Binding.Descriptor_Count = 1;
			Mesh_Point_Light_Shadow_Global_Layout_Per_Draw_Call_Vertex_Blending_Storage_Buffer_Binding.Stage_Flags = to_underlying(RHI_SHADER_STAGE_FLAG_BITS::RHI_SHADER_STAGE_VERTEX_BIT);
			Mesh_Point_Light_Shadow_Global_Layout_Per_Draw_Call_Vertex_Blending_Storage_Buffer_Binding.Immutable_Samplers = nullptr;
		}
		const vector<const RHI_Descriptor_Set_Layout_Binding*> Bindings{
			&Mesh_Point_Light_Shadow_Global_Layout_Per_Frame_Storage_Buffer_Binding,
			&Mesh_Point_Light_Shadow_Global_Layout_Per_Draw_Call_Storage_Buffer_Binding,
			&Mesh_Point_Light_Shadow_Global_Layout_Per_Draw_Call_Vertex_Blending_Storage_Buffer_Binding
		};
	...
	void Point_Light_Pass::Setup_Descriptor_Set(void) {
		...
		RHI_Descriptor_Buffer_Info Per_Frame_Storage_Buffer_Info{};
		{
			...
			Per_Frame_Storage_Buffer_Info.Range = sizeof(Mesh_Point_Light_Shadow_Per_Frame_Storage_Buffer_Object);
		}
		...
		RHI_Descriptor_Buffer_Info Per_Draw_Call_Storage_Buffer_Info{};
		{
			...
			Per_Draw_Call_Storage_Buffer_Info.Range = sizeof(Mesh_Point_Light_Shadow_Per_Draw_Call_Storage_Buffer_Object);
		}
		...
		RHI_Descriptor_Buffer_Info Per_Draw_Call_Vertex_Blending_Storage_Buffer_Info{};
		{
			...
			Per_Draw_Call_Vertex_Blending_Storage_Buffer_Info.Range = sizeof(Mesh_Point_Light_Shadow_Per_Draw_Call_Vertex_Blending_Storage_Buffer_Object);
		}
	...
	void Point_Light_Pass::Setup_Pipeline(void) {
		...
		unique_ptr<RHI_Shader_Module> Vertex_Shader_Module{ this->m_RHI->Create_Shader_Module(&MESH_POINT_LIGHT_SHADOW_VERT) };
		...
		unique_ptr<RHI_Shader_Module> Geometry_Shader_Module{ this->m_RHI->Create_Shader_Module(&MESH_POINT_LIGHT_SHADOW_GEOM) };

		RHI_Pipeline_Shader_Stage_Create_Info Geometry_Pipeline_Shader_Stage_Create_Inof{};
		{
			Geometry_Pipeline_Shader_Stage_Create_Inof.sType = RHI_STRUCT_TYPE::RHI_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
			Geometry_Pipeline_Shader_Stage_Create_Inof.Flags = 0;
			Geometry_Pipeline_Shader_Stage_Create_Inof.Stage = RHI_SHADER_STAGE_FLAG_BITS::RHI_SHADER_STAGE_GEOMETRY_BIT;
			Geometry_Pipeline_Shader_Stage_Create_Inof.Module = Geometry_Shader_Module.get();
			Geometry_Pipeline_Shader_Stage_Create_Inof.Name = "main";
			Geometry_Pipeline_Shader_Stage_Create_Inof.Specialization_Info = nullptr;
		}

		unique_ptr<RHI_Shader_Module> Fragment_Shader_Module{ this->m_RHI->Create_Shader_Module(&MESH_POINT_LIGHT_SHADOW_FRAG) };
		...
		const vector<const RHI_Pipeline_Shader_Stage_Create_Info*> Shader_Stages{
			...
			&Geometry_Pipeline_Shader_Stage_Create_Inof,
