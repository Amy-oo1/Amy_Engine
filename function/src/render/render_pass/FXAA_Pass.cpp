...
namespace NameSpace_Function::NameSpace_Render::NameSpace_Pass {
	...
	void FXAA_Pass::Pre_Inittialize(const Render_Pass_Pre_Initialize_Info* Init_Info) {
		const auto FXAA_Info{ static_cast<const FXAA_Render_Pass_Pre_Initialize_Info*>(Init_Info) };
		{
	...
	void FXAA_Pass::Post_Inittialize(const Render_Pass_Post_Initialize_Info* Init_Info)
	{
	}
