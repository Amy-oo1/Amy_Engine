...
namespace NameSpace_Function::NameSpace_Render::NameSpace_Pass {
	...
	FXAA_Pass::FXAA_Pass(const Render_Pass_Command_Info& Command_Info, RHI_Render_Pass* Render_Pass, RHI_Image_View* Image_View)
	...
	void FXAA_Pass::Updata_After_Frame_Buffer_ReCreate(RHI_Image_View* Image_View) {
		RHI_Descriptor_Image_Info Image_Info{};
		{
			Image_Info.Sampler = this->m_RHI->Get_Default_Sampler(RHI_DEFAULT_SAMPLER_TYPE::DEFAULT_SAMPLER_LINEAR);
			Image_Info.Image_View = Image_View;
			Image_Info.Image_Layout = RHI_IMAGE_LAYOUT::RHI_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL;
		}
		const vector<const RHI_Descriptor_Image_Info*> Image_Infos{ &Image_Info };
